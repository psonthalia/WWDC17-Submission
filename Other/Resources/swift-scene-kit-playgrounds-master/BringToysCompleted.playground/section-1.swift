...
class MyScene : SCNScene, SCNProgramDelegate  {
    ...
    override init() {
        ...
        var path = Bundle.mainBundle().pathForResource("passthrough", ofType: "vert")
        ...
        program.setSemantic(SCNGeometrySourceSemanticVertex.rawValue, forSymbol: "a_vertex", options: nil)
